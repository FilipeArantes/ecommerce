...
class Router extends RoteadorAbstract
{
    public function __construct()
    {
        ...
        $this->adicionarRota('GET', '/pedidoCount', PedidoController::class, 'count', JWTMiddleware::class, true);
        $this->adicionarRota('GET', '/pedidosRecentes', PedidoController::class, 'recentes', JWTMiddleware::class, true);
        $this->adicionarRota('GET', '/rendimento', PedidoController::class, 'sum', JWTMiddleware::class, true);
